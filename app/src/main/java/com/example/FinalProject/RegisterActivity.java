...
public class RegisterActivity extends AppCompatActivity {
    ...
    private static String URL = "http://172.26.9.32/Rest-API/API/Register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //the button to check the BMA

        BMA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                goToURL("https://www.calculator.net/body-fat-calculator.html");
            }
        });
    ...
    private void registration() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(RegisterActivity.this, "Register crash error " + error.toString(), Toast.LENGTH_LONG).show();
                loading.setVisibility(View.GONE);
                register.setVisibility(View.VISIBLE);
